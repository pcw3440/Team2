        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-md-8">
              ...
              <div class="card-body">
                <p class="card-text">
                아이디<br>
                <input type="text" name="id" placeholder="4~30자리 / 영문, 숫자, 특수문자'_' 사용가능" style="width:500px;" required>
                <input type="button" value="중복확인" >
                <br>
                비밀번호<br>
                <input type="password" name="password" placeholder="8~16자리 / 영문 대소문자, 숫자, 특수문자 조합" style="width:500px;">
                <input type="button" value="사용확인" >
                <br>
                이름<br>
                <input type="text" name="name_ceo" placeholder="이름 입력" style="width:300px;"><br>
                전화번호<br>
                ...
                <br>
                이메일<br>
                <input type="email"  name = "email1_ceo" style="width:80px;">@<input type="text"  name = "email2_ceo" style="width:150px;" placeholder="직접입력">
                <select style="width:100px;margin-right:10px" name="selectEmail" id="selectEmail">
                <option value="naver.com" selected>naver.com</option>
                <option value="gmail.com">gmail.com</option>
                <option value="hanmir.com">hanmail.com</option>
           		</select>
           	</p> 
