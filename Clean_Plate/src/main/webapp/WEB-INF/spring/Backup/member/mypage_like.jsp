        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-md-8">
                ...
                <table class="table table-striped mt-5 text-center" >
                    ...
                    <tbody>
                        <tr >
                            <td><img src="../image/soba.png" class="img-thumbnail" alt="칸다소바" style="width: 150px; height: 150px;"></td>
                            <td>칸다소바</td>
                            <td>별점표현</td>
                            <td>리뷰수</td>
                            <td>
                                <button type="button" class="btn btn-outline-secondary text-black p-3">바로예약</button>
