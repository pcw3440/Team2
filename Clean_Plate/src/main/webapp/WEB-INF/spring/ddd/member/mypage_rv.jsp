        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-2 align-items-center d-flex">
                ...
                <div class="btn-group-vertical btn-group-lg d-flex align-self-start" role="group" aria-label="Vertical button group">
                    ...
                    <button type="button" class="btn btn-outline-secondary active text-black p-3" onclick="location.href='../member/mypage_rv.jsp'">내가 쓴 리뷰</button>
            ...
            <div class="col-md-8">
                ...
                <div class="row align-items-center ">
                    <div class="card ms-3 me-5 mt-5 align-items-center" style="width: 25rem;">
                        ...
                        <div class="card-body">
                          <h5 class="card-title">식당11111</h5>
                          <p class="card-text">별점 작성일 리뷰 내용</p>
                          <a href="#" class="btn btn-secondary">리뷰 상세보기</a>
                        </div>
                    </div>
                    <div class="card mt-5 align-items-center" style="width: 25rem;">
                        <img src="..." class="card-img-top" alt="리뷰사진">
                        <div class="card-body">
                          <h5 class="card-title">식당22222</h5>
                          <p class="card-text">별점 작성일 리뷰 내용</p>
                          <a href="#" class="btn btn-secondary">리뷰 상세보기</a>
                        </div>
                    </div>
