...
<!-- 서브 메뉴 버튼 -->
        <div class="col-6">
            <div class="list-group list-group-horizontal">
                <a href="../help/help_fq.jsp" class="list-group-item list-group-item-action">회원</a>
                <a href="../help/help_fq_2.jsp" class="list-group-item list-group-item-action active" aria-current="true">점주</a>
            </div>
        </div>
    </div>
</div>
